...
public abstract class Game {
    ...
    protected BonusablePaddle playOnePaddle;
    private int playerTwoScore;
    protected BonusablePaddle playTwoPaddle;
    private int victoryScore;
    protected ArrayList<Collidable> objects;
    protected ArrayList<BonusPuckable> pucks;
    ...
    public void addPuck(BonusPuckable ball) {
        this.pucks.add(ball);
    }

    public ArrayList<BonusPuckable> getPucks() {
        // Also shallow copy
        return (ArrayList<BonusPuckable>) pucks.clone();
    }
    ...
    public void move() {
        ...
        for (BonusPuckable puck : pucks) {
            checkCollision(puck);
            puck.move();
        }
    }

    public void checkCollision(BonusPuckable puck) {
    ...
    protected void addPlayerPaddle(int player, BonusablePaddle paddle) {
        if (player == 1) {
    ...
    public abstract void collisionHandler(BonusPuckable puck, Collision collision);
