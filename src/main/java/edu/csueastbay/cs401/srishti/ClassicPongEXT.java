...
public class ClassicPongEXT extends GameEXT {
	...
	public ClassicPongEXT(int victoryScore, double fieldWidth, double fieldHeight) {
		...
		Paddle playerOne = new Paddle("Player 1 Paddle", 50, (this.fieldHeight / 2) - 50, 30, 150, 10,
				this.fieldHeight - 10);
		playerOne.setFill(Color.GREEN);
		addPlayerPaddle(1, playerOne);

		Paddle playerTwo = new Paddle("Player 2 Paddle", this.fieldWidth - 50, (this.fieldHeight / 2) - 50, 30, 150, 10,
				this.fieldHeight - 10);
