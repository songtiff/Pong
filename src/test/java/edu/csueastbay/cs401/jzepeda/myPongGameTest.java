...
import edu.csueastbay.cs401.jzepeda.myPongGame;
...
/**
 * Not Sure How To Test Code, Applied From ClassicPongTest
 */
class myPongGameTest {

    myPongGame game;

    @BeforeEach
    void setUp() {
        game = new myPongGame(10, 1300, 860);
    }
    ...
    void shouldHaveTopWall() {
        ...
        assertEquals(100, top_wall.getY());
    ...
    void mapRange0to10and30to50() {
        double result = myPongGame.mapRange(0,10,30,50, 5);
    ...
    void mapRange100to200and20to50() {
        double result = myPongGame.mapRange(200,300,20,50, 225);
