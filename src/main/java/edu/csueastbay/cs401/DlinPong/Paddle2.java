...
public class Paddle2 extends Rectangle implements Collidable {
    public static final double STARTING_SPEED = 7.5;
    private String id;
    ...
    public Paddle2(String id, double x, double y, double width, double height, double topBound, double bottomBound) {
